...
//ТОЧКА КООРДИНАТ
  ...
  private static void task3() {
    ...
    studentPetya.setGrades(studentVasya.getGrades()); 
    System.out.println("   " + studentPetya);

    System.out.println("3. Заменить первую оценку Пети на число 5");
    int[] petyaGrades = studentPetya.getGrades();
    petyaGrades[0] = 5;
    studentPetya.setGrades(petyaGrades);
    ...
    int[] andreyGrades = studentVasya.getGrades().clone();
    studentAndrey = new Student("Андрей", andreyGrades);
    System.out.println("   " + studentAndrey);

    System.out.println("Изменяем оценку Васи:");
    int[] newVasyaGrades = studentVasya.getGrades();
    newVasyaGrades[0] = 2;
    studentVasya.setGrades(newVasyaGrades);

    System.out.println("После изменения оценки Васи:");
    System.out.println("   " + studentVasya);
    System.out.println("   " + studentAndrey);
    System.out.println("Оценки Андрея не изменились - копия независимая");
  }
  ...
  private static void task4() {
    ...
    System.out.println("\nВсе точки созданы через конструктор с обязательными координатами");
  }
  ...
  private static void task5() {
    ...
    System.out.println("\nОба студента созданы через один конструктор с разными параметрами");
  }
